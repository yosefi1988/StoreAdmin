...
namespace WebApplicationStoreAdmin.Models
{
    ...
    public partial class SD_SendBoxs
    {
        ...
        public Nullable<int> SendPriceID { get; set; }
        ...
        public virtual BD_SendStatusTypes BD_SendStatusTypes { get; set; }
        public virtual BD_SendBoxPrices BD_SendBoxPrices { get; set; }
